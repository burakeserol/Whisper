...
public class ReadFromDB extends DatabaseController{
	...
	protected String doInBackground(String... params ) {
		...
		try {
	        ...
	        System.out.println("columnname" + columnName + " rownum " + params[0]);
	        
	    	SelectRequest selectRequest=  new SelectRequest("select * from AnnouncementInformation").withConsistentRead(true);
